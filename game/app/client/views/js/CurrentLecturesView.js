        ...
        lectures.forEach(lecture => {
            ...
            $('#currentLecturesContainer').append(`
                <div class="currentLecturesContainer d-flex flex-column align-items-start col-5 m-5 pt-3">
                    ...
                    <span id="waitforlectureload" style="color: antiquewhite; display:none" class="align-self-end mt-1 p-2"><i class="fas fa-spinner fa-spin navbarIcons"></i> Please wait...</span>
